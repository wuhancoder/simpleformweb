...
customElements.define("my-file", MyFile); //?required=${this.myvalidation &&
...
class MyForm extends LitElement {
  ...
  renderInput(i) {
    ...
    if (i.input === "file") return html` <div class="row">
  ...
  submitForm(e) {
    let allInputs = [...this.shadowRoot.querySelectorAll("my-input, my-select, my-file")];
    ...
    allInputs.forEach(el => {
      ...
      if (el.tagName === "MY-FILE") formdata.append(el.name, el.files[0], el.files[0].name);else formdata.append(el.name, el.value);
    });
    fetch(this.action, {
      method: "POST",
      // or 'PUT'
